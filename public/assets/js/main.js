...
/**
 * SkillCrust logo intro. Shows a short animated logo curtain the first
...
function initLogoSplash() {
  ...
  el.innerHTML =
    ...
    window.logoMarkSvg() +
    '<div class="splash-word">Skill<span>Crust</span></div>' +
    '<div class="splash-tag">Learn \u00b7 Share \u00b7 Earn</div>' +
...
/** Inline SVG logo mark — layered "crust" of skills with a spark. */
